        ...
        <footer class="mt-2 mt-sm-5 pt-5 px-0 px-sm-4">
            <div class="container-fluid">
                ...
                <div class="text-center">
                    <p class="copyright-link text-uppercase m-0 py-3">Copyright 2023 - al firdous quality products | <a class="text-decoration-none copyright-link  footer-social" href="#">Terms of sales</a> | <a class="text-decoration-none copyright-link copyright-link-a" href="#">PDPA</a> | <a class="text-decoration-none copyright-link copyright-link-a" href="#">Report a Problem</a> </p>
                </div>
            </div>
        </footer>
