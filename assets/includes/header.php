        ...
        <div class="container-fluid d-none d-lg-block">
            <div id="desktop-nav-js" class="nav-bg about-nav-bg mt-4 row px-4 py-4 border border-1 border-top-0 border-bottom-0 mb-5">
                <div class="col-lg-4 d-flex">
                    <a class="text-decoration-none p-2 mx-4 text-dark nav-a fs-5 <?php active('index.php');?>" href="index.php">Home</a>
                    <a class="text-decoration-none p-2 mx-4 text-dark nav-a fs-5 <?php active('about.php');?>" href="about.php">About</a>
                </div>
